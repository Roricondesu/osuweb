...
请通过邮件将漏洞详情发送至 **osuweb-security@example.com**，并在邮件中包含以下信息（中英文均可）：
...
Instead, please send the details by email to **osuweb-security@example.com**, including the following information (Chinese or English):
